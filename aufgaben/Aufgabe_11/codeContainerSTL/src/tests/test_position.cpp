...
namespace oopTutorium
{
    ...
    void testSortVectorPositions(){
        std::vector<Position> positions0 = {Position("X", 1, 1), Position("Y", 1, 1), Position("X", 1, 2), Position("X", 2, 1), Position("A", 12, 34), Position("Z", -43, -21)};
        oopTutorium::sort(positions0);
        test_sort(positions0.data(), positions0.size());  

        std::vector<Position> positions1 = {Position("A", 0, 0), Position("A", 1, 0), Position("A", 2, 0), Position("A", 3, 0), Position("A", 3, 1), Position("A", 3, 2), Position("A", 4, 0)};
        oopTutorium::sort(positions1);
        test_sort(positions1.data(), positions1.size());  
    }
}
...
int main()
{
    ...
    oopTutorium::test_sortChars();
    oopTutorium::testSortVectorPositions();
